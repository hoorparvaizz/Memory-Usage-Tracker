...
class MemoryTrackerApp(tk.Tk):
    ...
    def toggle_theme(self):
        ...
        self.configure_styles()
        self._configure_plot_colors()
        # Update colors of treeview and its headings
        self.process_tree.config(background=self._get_axis_bg(), foreground=self._get_fg_color())
        self.style.configure("Treeview.Heading", background=self._get_axis_bg(), foreground=self._get_fg_color())
        self.style.map("Treeview.Heading",
